...
export const dimensionMeta: Record<DimensionKey, DimensionMeta> = {
  S1: { key: 'S1', name: 'S1 自尊自信', model: '自我模型' },
  S2: { key: 'S2', name: 'S2 自我清晰度', model: '自我模型' },
  S3: { key: 'S3', name: 'S3 核心价值', model: '自我模型' },
  E1: { key: 'E1', name: 'E1 依恋安全感', model: '情感模型' },
  E2: { key: 'E2', name: 'E2 情感投入度', model: '情感模型' },
  E3: { key: 'E3', name: 'E3 边界与依赖', model: '情感模型' },
  A1: { key: 'A1', name: 'A1 世界观倾向', model: '态度模型' },
  A2: { key: 'A2', name: 'A2 规则与灵活度', model: '态度模型' },
  A3: { key: 'A3', name: 'A3 人生意义感', model: '态度模型' },
  Ac1: { key: 'Ac1', name: 'Ac1 动机导向', model: '行动驱力模型' },
  Ac2: { key: 'Ac2', name: 'Ac2 决策风格', model: '行动驱力模型' },
  Ac3: { key: 'Ac3', name: 'Ac3 执行模式', model: '行动驱力模型' },
  So1: { key: 'So1', name: 'So1 社交主动性', model: '社交模型' },
  So2: { key: 'So2', name: 'So2 人际边界感', model: '社交模型' },
  So3: { key: 'So3', name: 'So3 表达与真实度', model: '社交模型' },
}
...
export const modelGroups = [
  { name: '自我模型', icon: 'lucide:user', dims: ['S1', 'S2', 'S3'] as DimensionKey[] },
  { name: '情感模型', icon: 'lucide:heart', dims: ['E1', 'E2', 'E3'] as DimensionKey[] },
  { name: '态度模型', icon: 'lucide:compass', dims: ['A1', 'A2', 'A3'] as DimensionKey[] },
  { name: '行动驱力模型', icon: 'lucide:zap', dims: ['Ac1', 'Ac2', 'Ac3'] as DimensionKey[] },
  { name: '社交模型', icon: 'lucide:users', dims: ['So1', 'So2', 'So3'] as DimensionKey[] },
]
